      ...
      <div className="flex flex-col lg:flex-row items-center justify-between mx-20 mb-3">
        <div className="flex flex-col gap-4 mt-10 text-center">
          ...
          <div className="flex items-center justify-center gap-6">
              ...
              <Image src="/assets/instagram.png" width="24" height="24"/>
              <Image src="/assets/linkind.png" width="30" height="28"/>
              <Image src="/assets/twitter.png" width="30" height="28"/>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 mt-10 text-center ">
          <h2 className="text-white">Redes Sociales</h2>
          <div className="flex items-center justify-center gap-6">
              <Image src="/assets/portugal.png" width="24" height="24"/>
              <Image src="/assets/estados_unidos.png" width="24" height="24"/>
              <Image src="/assets/mexico.png" width="24" height="28"/>
          </div>
        </div>
