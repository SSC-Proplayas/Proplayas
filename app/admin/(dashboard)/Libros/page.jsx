...
const Page = () => {
  ...
  return (
    <Layout>
      ...
      <div>
      <Link href='/admin/Agregarlibros'><button className="rounded-md mt-3 ml-8 py-1 px-2 text-white bg-black">+ Agregar Libros</button></Link>
          ...
          <div className='flex justify-between'>
            ...
            <tbody>
              <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-t border-gray-300">
                ...
                <p className='h-24 w-32 md:w-auto md:h-auto overflow-y-auto'>El océano es quizás el elemento más perjudicado por las acciones del ser humano y también el menos conocido. Vivimos ignorantes del verdadero diamante del planeta porque solo nos preocupamos por la vida sobre tierra. Lo que no sabemos es que bajo nuestros pies hay un mundo muy complejo, tanto, que solo ha llegado a explorarse el 5%. Imagina lo que queda aún por descubrir.</p>
                </td>
                <td className="px-6 py-2">
